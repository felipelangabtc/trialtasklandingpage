...
export const metadata: Metadata = {
  ...
  description: 'Microburbs Terms of Service - Legal agreement for using our platform.',
};
    ...
    <div className="container mx-auto px-4 py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            By accessing and using Microburbs ("the Service"), you accept and agree
          ...
          <p>
            Microburbs provides street-level property intelligence, risk analysis,
            and data visualization tools for buyers agents and property investors in
            Australia.
          </p>
          ...
          <p>
            ...
            provide accurate, current, and complete information and to update it as
            necessary.
          </p>
          ...
          <h3>5.1 Our Data</h3>
          <p>
            All data, maps, reports, and analysis provided by Microburbs are owned
            by us or our licensors. You receive a limited license to use this data
          ...
          <h3>6.1 Fees</h3>
          <p>
            Access to certain features requires a paid subscription. Fees are billed
            in advance on a monthly or annual basis.
          </p>

          <h3>6.2 Cancellation</h3>
          <p>
            You may cancel your subscription at any time. Cancellations take effect
            at the end of the current billing period. No refunds for partial months.
          </p>

          <h3>6.3 Free Trials</h3>
          <p>
            Free trials are available for new users. If you do not cancel before the
            trial ends, you will be charged for a subscription.
          </p>

          <h2>7. Intellectual Property</h2>
          <p>
            All content, trademarks, and data on this platform, including but not
            limited to software, databases, text, graphics, icons, and logos, are
            the property of Microburbs or our licensors.
          </p>

          <h2>8. Disclaimer of Warranties</h2>
          <p>
            THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS
            OR IMPLIED. WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED OR
            ERROR-FREE.
          </p>

          <h2>9. Limitation of Liability</h2>
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, MICROBURBS SHALL NOT BE LIABLE
          ...
          <p>
            ...
            resolved in the courts of [State/Territory].
          </p>
          ...
          <p>
            Email:{' '}
            <a href="mailto:legal@microburbs.com" className="text-primary hover:underline">
