 ...
 * Uses safe defaults with warnings instead of throwing errors.
 * This ensures the app can start even with missing optional variables.
 */
  ...
  if (!parsed.success) {
    ...
    return {
      NODE_ENV:
        ...
        'production',
      NEXT_PUBLIC_APP_URL:
        process.env.NEXT_PUBLIC_APP_URL || 'https://microburbs.com',
